...
export function Team() {
  ...
  return (
    ...
    >
      {/* Background Pattern - Solid colors, no gradients */}
      <motion.div 
        style={{ y: backgroundY }}
        className="absolute inset-0 opacity-30"
      >
        <div className="absolute -right-32 top-20 h-96 w-96 rounded-full bg-[#C72C5B]/20" />
        <div className="absolute -left-20 bottom-20 h-64 w-64 bg-[#8B5CF6]/20" />
      </motion.div>
                ...
                <div className="flex flex-col justify-center p-8 lg:p-12">
                  ...
                  <div className="mb-6 space-y-2">
                    {featuredMember.achievements.slice(0, 2).map((achievement) => (
                      <div key={achievement} className="flex items-center gap-2 text-sm text-gray-400">
                  ...
                  <div className="flex items-center gap-3">
                    <motion.a
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#C72C5B]"
                    >
            ...
            >
              <Link href={`/who/${member.id}/`}>
                <motion.div
                  whileHover={{ y: -8 }}
                  transition={{ duration: 0.3 }}
                  className="group h-full overflow-hidden rounded-2xl bg-gray-900"
                >
                  {/* Image */}
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="mb-2 text-xl font-bold text-white group-hover:text-[#C72C5B] transition-colors">
                      {member.name}
                    </h3>
                    ...
                    <div className="flex items-center gap-2">
                      <motion.a
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-white/5 text-white/60 transition-colors hover:bg-[#C72C5B] hover:text-white"
                      >
