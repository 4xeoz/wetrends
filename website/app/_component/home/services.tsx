...
const services = [
  ...
  },
  {
    ...
    icon: Globe,
    title: 'Web Design',
    description: 'Web design and development for custom websites, e-commerce and Next.js applications.',
    category: "Web",
    slug: 'web-design',
  ...
  },
  {
    ...
    icon: Users,
    title: 'Social Media',
    description: 'Social media management across content strategy, community, paid social and analytics.',
    category: "Social",
    slug: 'social-media',
  ...
  },
  {
    ...
    description: 'SEO content, copywriting, editorial systems and storytelling built around useful buyer questions.',
    category: "Content",
