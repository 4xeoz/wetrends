  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gray-100">
      <div className="container px-4 sm:px-6 md:px-8">
        <div className="flex flex-col lg:flex-row justify-between gap-12 md:gap-16 items-start">
          {/* Left: Title and Description */}
          <div className="max-w-xl mx-auto md:mx-0 md:col-span-1 text-left mb-10 sm:mb-12 md:mb-0">
          ...
          {/* Right: FAQ Items */}
          <div className="max-w-2xl mx-auto md:mx-0 md:col-span-2 w-full">
