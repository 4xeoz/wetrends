...
const testimonials = [
  {
    ...
    quote:
      "I was sceptical at first — £45 for photos and a video seemed almost too affordable. But the quality blew me away. My LinkedIn has never looked so good. Photos arrived the very next day.",
    color: '#0F0F0F',
  },
  {
    initials: 'JA',
