...
/**
 * Bottom-aligned statement hero: small tracked label, then one oversized clamp
 * headline whose second line drops into the serif italic accent.
 *
 * Type scale and the `font-serif italic font-thin` accent are lifted from the
 * home hero (`app/_component/home/hero.tsx`) so the pages read as one site.
 * The blog hero (`app/_component/blogs/blog-hero.tsx`) is the same skeleton on
 * warm paper — change one and look at the other.
 *
 * Height is capped at ~80svh so the reel rails below break the fold and show
